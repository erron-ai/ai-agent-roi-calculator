...
## Objective
Maintain `ai-agent-roi-calculator` as a reliable, useful, and test-first project aligned with its primary promise:
> Interactive web tool for estimating deployment ROI using market data.
